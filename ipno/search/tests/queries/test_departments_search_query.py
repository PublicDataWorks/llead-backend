...
class DepartmentsSearchQueryTestCase(TestCase):
    def test_query(self):
        ...
        department_3 = DepartmentFactory(name='New Orleans Parish Sheriff Office', officer_fraction=0.55)
    ...
    def test_aliases_query(self):
        ...
        department_3 = DepartmentFactory(name='Baton Rouge PD', aliases=['Orleans'], officer_fraction=0.2)
    ...
    def test_query_with_specified_department(self):
        ...
        DepartmentFactory(name='New Orleans Parish Sheriff Office', officer_fraction=0.55)
