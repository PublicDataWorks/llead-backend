...
class MindenPressHeraldScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "LAIB President speaks to Chamber about upcoming Nov. 13 Amendments"
        )

        assert (
            self.articles[0]["link"].strip()
            == "https://press-herald.com/laib-president-speaks-to-chamber-about"
