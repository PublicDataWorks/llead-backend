...
class TheHawkeyeScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "https://ulmhawkeyeonline.com/28962/breaking-news/breaking-news/"
        )

        assert (
            self.articles[0]["guid"].strip() == "https://ulmhawkeyeonline.com/?p=28962"
        )

        assert (
            self.articles[0]["published_date"].strip()
            == "Tue, 12 Oct 2021 23:45:04 +0000"
        )
