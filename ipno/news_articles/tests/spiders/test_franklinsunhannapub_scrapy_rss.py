...
class TheFranklinSunScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        with open(
            join(dirname(__file__), "files", "franklinsunhannapub.xml"), "r"
        ) as f:
            file_content = f.read()
        ...
        assert (
            ...
            == "Patriots last home game of season dedicated to Veterans"
        )

        assert (
            self.articles[0]["link"].strip()
            == "https://www.hannapub.com/franklinsun/patriots-last-home-game-of"
        ...
        assert (
            ...
            == "http://www.hannapub.com/tncms/asset/editorial/fa62c974-1e09-11eb"
            "-88a5-eb76bcd86308"
        )
