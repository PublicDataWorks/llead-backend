...
from news_articles.constants import THETOWNTALK_SOURCE
...
from news_articles.spiders import TownTalkScrapyRssSpider
from officers.factories import OfficerFactory
from utils.constants import FILE_TYPES


class TownTalkScrapyRssSpiderTestCase(TestCase):
    @patch('news_articles.spiders.base_scrapy_rss.GoogleCloudService')
    def setUp(self, mock_gcloud_service):
        NewsArticleSourceFactory(source_name=THETOWNTALK_SOURCE)
        self.spider = TownTalkScrapyRssSpider()

    def test_parse_item_path(self):
        with open(join(dirname(__file__), 'files', 'thetowntalk.xml'), 'r') as f:
            file_content = f.read()
        feed_url = 'http://rssfeeds.thetowntalk.com/alexandria/news'
        ...
        assert self.articles[0]['title'].strip() == 'Pineville Fall Family Festival 2021'

        assert self.articles[0]['link'].strip() == 'https://www.thetowntalk.com/picture-gallery/news/2021/10/27' \
                                                   '/pineville-fall-festival-2021/8560784002/'

        assert self.articles[0]['guid'].strip() == 'https://www.thetowntalk.com/picture-gallery/news/2021/10/27' \
                                                   '/pineville-fall-festival-2021/8560784002/'

        assert self.articles[0]['published_date'] == 'Wed, 27 Oct 2021 00:48:53 +0000'

    @patch('news_articles.spiders.thetowntalk_scrapy_rss.ItemLoader')
    @patch('news_articles.spiders.thetowntalk_scrapy_rss.RSSItem')
    ...
    @patch('news_articles.spiders.thetowntalk_scrapy_rss.ArticlePdfCreator')
    def test_parse_article(self, mock_article_pdf_creator):
        ...
        assert new_article.source.source_name == 'thetowntalk'
        ...
        assert crawled_post.source.source_name == 'thetowntalk'
    ...
    def test_parse_guid(self):
        guid = 'https://www.thetowntalk.com/picture-gallery/news/2021/10/27/pineville-fall-festival-2021/8560784002/'
