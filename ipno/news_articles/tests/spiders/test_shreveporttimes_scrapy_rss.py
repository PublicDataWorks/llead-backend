...
class ShreveportTimesScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "Shreveport Green festival celebrates new urban farm project in food"
            " desert"
        )

        assert (
            self.articles[0]["link"].strip()
            == "https://www.shreveporttimes.com/story/news/2021/10/27/shreveport"
    ...
    def test_parse_guid(self):
        guid = (
            "https://www.shreveporttimes.com/picture-gallery/news/"
            "2021/10/27/pineville-fall-festival-2021/8560784002/"
        )
