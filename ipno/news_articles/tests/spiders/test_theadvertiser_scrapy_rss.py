...
class DailyAdvertiserScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "Lafayette middle-schooler 'gets curious' with Vice "
            "President Kamala Harris, NASA astronaut"
        )

        assert (
            self.articles[0]["link"].strip()
            == "https://www.theadvertiser.com/story/news/2021/10/26/lafayette"
    ...
    def test_parse_guid(self):
        guid = (
            "https://www.theadvertiser.com/story/news/2021/10/26/lafayette-middle-schooler-gets-curious-u-s-vice"
        ...
        assert (
            result
            == "lafayette-middle-schooler-gets-curious-u-s-vice-president-nasa-astronaut-6135881001"
        )
