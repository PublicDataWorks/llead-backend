...
class RustonDailyLeaderScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "https://uptownmessenger.com/2021/10/a-letter-from-latoya-cantrell"
            "-sponsored/"
        )

        assert (
            self.articles[0]["guid"].strip() == "https://uptownmessenger.com/?p=626533"
        )

        assert (
            self.articles[0]["published_date"].strip()
            == "Thu, 21 Oct 2021 16:45:23 +0000"
        )
