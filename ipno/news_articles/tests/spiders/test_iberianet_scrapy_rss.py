...
class IberianetScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert self.articles[0]['title'].strip() == 'Missouri hospitals in expensive race to hire health care staff ' \
                                                    'as COVID cases soar'

        assert self.articles[0]['link'].strip() == 'https://www.iberianet.com/national/health/missouri-hospitals-in' \
                                                   '-expensive-race-to-hire-health-care-staff-as-covid-cases-soar' \
                                                   '/article_865ca8b9-692f-57fb-8fc8-1789c5cccda8.html'

        assert self.articles[0]['guid'].strip() == 'http://www.iberianet.com/tncms/asset/editorial/865ca8b9-692f-57fb-8fc8-1789c5cccda8'

        assert self.articles[0]['published_date'].strip() == 'Tue, 17 Aug 2021 12:25:00 -0500'
    ...
    def test_parse_article(self, mock_article_pdf_creator):
        ...
        mock_css.assert_called_with(
            "div[itemprop=\"articleBody\"]>div>p, div[itemprop=\"articleBody\"] div[dir=\"auto\"], "
            "div[itemprop=\"articleBody\"]>div>div>p, .RichTextArticleBody-body"
        )
