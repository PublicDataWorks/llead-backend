...
class TheOouachitaCitizenScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        with open(
            join(dirname(__file__), "files", "ouachitacitizenhannapub.xml"), "r"
        ) as f:
            file_content = f.read()
        ...
        assert (
            ...
            == "Coaches preview stacked Bayou Jamb event"
        )

        assert (
            self.articles[0]["link"].strip()
            == "https://www.hannapub.com/ouachitacitizen/sports/coaches-preview"
        ...
        assert (
            ...
            == "http://www.hannapub.com/tncms/asset/editorial/ff134658-0439-11ec"
            "-9652-b7caffe97ad6"
        )
