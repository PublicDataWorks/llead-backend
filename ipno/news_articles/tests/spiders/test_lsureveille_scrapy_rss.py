...
class ReveilleScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "LSU to disclose COVID-19 cases to public, reports 22 positive "
            "cases in four days"
        )

        assert (
            self.articles[0]["link"].strip()
            == "https://www.lsureveille.com/coronavirus/lsu-to-disclose-covid-19"
        ...
        assert (
            ...
            == "http://www.lsureveille.com/tncms/asset/editorial/76dd2638-e274"
