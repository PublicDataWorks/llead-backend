...
class MyArkLamissScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "https://www.myarklamiss.com/news/top-stories/four-men-arrested"
            "-for-weapon-and-drug-charges-on-grambling-campus/"
        )

        assert (
            self.articles[0]["guid"].strip() == "https://www.myarklamiss.com/?p=951357"
        )

        assert (
            self.articles[0]["published_date"].strip()
            == "Wed, 20 Oct 2021 15:48:32 +0000"
        )
