...
class WGNOScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "New emergency protocols approved for New Orleans senior living "
            "facilities"
        )

        assert (
            self.articles[0]["link"].strip()
            == "https://wgno.com/hurricane-ida/new-emergency-protocols-approved"
