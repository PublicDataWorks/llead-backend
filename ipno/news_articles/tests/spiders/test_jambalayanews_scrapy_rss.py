...
class JambalayaNewsScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "https://www.jambalayanews.com/lifestyles/entertainment/kate"
        ...
        assert (
            ...
            == "http://www.jambalayanews.com/tncms/asset/editorial/d42d4c32-7743"
            "-5c3d-94a4-4086ddf43dc5"
        )

        assert (
            self.articles[0]["published_date"].strip()
            == "Thu, 21 Oct 2021 20:00:00 -0500"
        )
    ...
    def test_parse_article(self, mock_article_pdf_creator):
        ...
        mock_css.assert_called_with(
            'div[itemprop="articleBody"]>p, div[itemprop="articleBody"]'
            ' div[dir="auto"], .RichTextArticleBody-body,'
