...
class NolaScrapyRssSpiderTestCase(TestCase):
    ...
    def test_parse_item_path(self):
        ...
        assert (
            ...
            == "Our Views: Saints, LSU vaccine and test mandates are for the best. We"
            " need more."
        )

        assert (
            self.articles[0]["link"]
            == "https://www.theadvocate.com/baton_rouge/opinion/our_views/"
            "article_46cdaacc-05b3-11ec-9b27-27262c67532c.html"
        )

        assert (
            self.articles[0]["guid"]
            == "http://www.theadvocate.com/tncms/asset/editorial/46cdaacc-05b3-11ec-9b27-27262c67532c"
        )
