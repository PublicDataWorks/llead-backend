...
class BizNewOrleansScrapyRssSpider(ScrapyRssSpider):
    name = BIZNEWORLEANS_SOURCE
    allowed_domains = ["bizneworleans.com"]
    urls = ["https://www.bizneworleans.com/feed/"]
    guid_pre = "https://www.bizneworleans.com/?p="
