...
class TheOouachitaCitizenScrapyRssSpider(ScrapyRssSpider):
    name = OUACHITACITIZENHANNAPUB_SOURCE
    allowed_domains = ['hannapub.com']
    urls = ['https://www.hannapub.com/search/?f=rss&t=article&c=ouachitacitizen&l=100&s=start_time&sd=desc']
    guid_pre = 'http://www.hannapub.com/tncms/asset/editorial/'
