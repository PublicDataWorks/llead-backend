...
class BossierPressScrapyRssSpider(ScrapyRssSpider):
    name = BOSSIERPRESS_SOURCE
    allowed_domains = ['bossierpress.com']
    urls = ['https://bossierpress.com/feed/']
    guid_pre = 'https://bossierpress.com/?p='
    ...
    def parse_article(self, response):
        ...
        content_paragraphs = response.css(".td-post-content>:not(aside):not(nav):not(img):not(div)").getall()
