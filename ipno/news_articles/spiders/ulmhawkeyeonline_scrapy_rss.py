...
class TheHawkeyeScrapyRssSpider(ScrapyRssSpider):
    name = ULMHAWKEYEONLINE_SOURCE
    allowed_domains = ['ulmhawkeyeonline.com']
    urls = ['https://ulmhawkeyeonline.com/feed/']
    guid_pre = 'https://ulmhawkeyeonline.com/?p='
    ...
    def parse_article(self, response):
        ...
        content_paragraphs = response.css(".storycontent>p").getall()
