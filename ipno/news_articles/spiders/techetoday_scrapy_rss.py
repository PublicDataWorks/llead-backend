...
class TecheTodayScrapyRssSpider(ScrapyRssSpider):
    name = TECHETODAY_SOURCE
    allowed_domains = ["techetoday.com"]
    urls = ["https://www.techetoday.com/rss.xml"]
    guid_post = " at https://www.techetoday.com"
