...
class MyArkLamissScrapyRssSpider(ScrapyRssSpider):
    name = MYARKLAMISS_SOURCE
    allowed_domains = ['myarklamiss.com']
    urls = ['https://www.myarklamiss.com/feed/']
    guid_pre = 'https://www.myarklamiss.com/?p='
    ...
    def parse_article(self, response):
        ...
        content_paragraphs = response.css(".article-content>p").getall()
