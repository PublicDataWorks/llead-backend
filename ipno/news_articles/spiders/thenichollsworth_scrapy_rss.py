...
class NichollsWorthScrapyRssSpider(ScrapyRssSpider):
    name = THENICHOLLSWORTH_SOURCE
    allowed_domains = ["thenichollsworth.com"]
    urls = ["https://thenichollsworth.com/feed/"]
    guid_post = "https://thenichollsworth.com/?p="
