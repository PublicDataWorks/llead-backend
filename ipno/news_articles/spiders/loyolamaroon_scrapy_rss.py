...
class LoyolaMaroonScrapyRssSpider(ScrapyRssSpider):
    name = LOYOLAMAROON_SOURCE
    allowed_domains = ["loyolamaroon.com"]
    urls = ["https://loyolamaroon.com/feed/"]
    guid_pre = "https://loyolamaroon.com/?p="
