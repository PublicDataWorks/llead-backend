...
class HeraldGuideScrapyRssSpider(ScrapyRssSpider):
    name = HERALDGUIDE_SOURCE
    allowed_domains = ["heraldguide.com"]
    urls = ["https://www.heraldguide.com/feed/"]
    guid_pre = "https://www.heraldguide.com/?p="
