...
class ConcordiaSentinelScrapyRssSpider(ScrapyRssSpider):
    name = CONCORDIASENTINELHANNAPUB_SOURCE
    allowed_domains = ['hannapub.com']
    urls = ['https://www.hannapub.com/search/?f=rss&t=article&c=concordiasentinel&l=100&s=start_time&sd=desc']
