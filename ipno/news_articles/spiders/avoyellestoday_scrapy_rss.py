...
class AvoyellesTodayScrapyRssSpider(ScrapyRssSpider):
    name = AVOYELLESTODAY_SOURCE
    allowed_domains = ["avoyellestoday.com"]
    urls = ["https://www.avoyellestoday.com/rss.xml"]
    guid_post = " at https://www.avoyellestoday.com"
