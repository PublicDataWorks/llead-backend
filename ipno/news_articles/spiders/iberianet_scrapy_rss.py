...
class IberianetScrapyRssSpider(ScrapyRssSpider):
    name = IBERIANET_SOURCE
    allowed_domains = ['iberianet.com']
    urls = [
        'https://www.iberianet.com/search/?f=rss&t=article&l=50&s=start_time&sd=desc'
    ]
    guid_pre = 'http://www.iberianet.com/tncms/asset/editorial/'
