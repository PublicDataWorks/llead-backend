...
class JambalayaNewsScrapyRssSpider(ScrapyRssSpider):
    name = JAMBALAYANEWS_SOURCE
    allowed_domains = ['jambalayanews.com']
    urls = [
        'https://www.jambalayanews.com/search/?f=rss&t=article&l=50&s=start_time&sd=desc'
    ]
    guid_pre = 'http://www.jambalayanews.com/tncms/asset/editorial/'
