...
class UptownMessengerScrapyRssSpider(ScrapyRssSpider):
    name = UPTOWNMESSENGER_SOURCE
    allowed_domains = ["uptownmessenger.com"]
    urls = ["https://uptownmessenger.com/feed/"]
    guid_pre = "https://uptownmessenger.com/?p="
    ...
    def parse_article(self, response):
        ...
        raw_parsed_author = response.css('span[itemprop="author"]').getall()
