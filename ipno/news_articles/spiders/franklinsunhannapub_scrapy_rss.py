...
class TheFranklinSunScrapyRssSpider(ScrapyRssSpider):
    name = FRANKLINSUNHANNAPUB_SOURCE
    allowed_domains = ['hannapub.com']
    urls = ['https://www.hannapub.com/search/?f=rss&t=article&c=franklinsun&l=100&s=start_time&sd=desc']
