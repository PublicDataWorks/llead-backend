...
class CapitalCityNewsScrapyRssSpider(ScrapyRssSpider):
    name = CAPITALCITYNEWS_SOURCE
    allowed_domains = ["capitalcitynews.us"]
    urls = ["http://capitalcitynews.us/?feed=rss2"]
    guid_pre = "http://capitalcitynews.us/?p="
