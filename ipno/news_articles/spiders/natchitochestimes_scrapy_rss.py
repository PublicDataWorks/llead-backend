...
class NatchiochesTimesScrapyRssSpider(ScrapyRssSpider):
    name = NATCHITOCHESTIMES_SOURCE
    allowed_domains = ["natchitochestimes.com"]
    urls = ["https://www.natchitochestimes.com/feed/"]
    guid_pre = "https://www.natchitochestimes.com/?p="
