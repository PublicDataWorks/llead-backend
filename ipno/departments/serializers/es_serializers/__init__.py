from .department_document_es_serializer import DepartmentDocumentsESSerializer
from .department_news_article_es_serializer import DepartmentNewsArticlesESSerializer
