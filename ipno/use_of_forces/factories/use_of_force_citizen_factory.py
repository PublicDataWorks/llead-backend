...
class UseOfForceCitizenFactory(factory.django.DjangoModelFactory):
    ...
    citizen_arrest_charges = factory.LazyFunction(lambda: fake.pyint())
    citizen_hospitalized = factory.LazyFunction(lambda: fake.pyint())
    citizen_injured = factory.LazyFunction(lambda: fake.word())
    citizen_build = factory.LazyFunction(lambda: fake.word())
    citizen_height = factory.LazyFunction(lambda: fake.word())
