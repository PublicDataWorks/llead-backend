...
class AgencyImporterTestCase(TestCase):
    def setUp(self):
        ...
        self.agency4_data = ['bossier-so', 'Bossier Parish SO', '(30.006161, -90.2640043)']
        self.agency5_data = ['louisiana-state-pd', 'Louisiana State PD', '(29.955935, -90.0663388)']
        self.agency6_data = ['baton-rouge-pd', 'Baton Rouge PD', '(29.955935, -90.0663388)']
    ...
    def test_upload_file_success(self):
        ...
        agency_importer = AgencyImporter()
        agency_importer.gs = MagicMock(upload_file_from_string=mock_upload_file_from_string)

        department_image_url = agency_importer.upload_file(upload_location, file_blob)

        mock_upload_file_from_string.assert_called_with(upload_location, file_blob, 'image/png')
