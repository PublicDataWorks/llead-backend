...
class OfficerImporterTestCase(TestCase):
    def setUp(self):
        self.header = ['uid', 'last_name', 'middle_name', 'first_name', 'birth_year', 'birth_month', 'birth_day',
                       'race', 'sex']
        self.officer1_data = ['uid1', 'Sanchez', 'C', 'Emile', '1938', '', '', 'white', 'male']
        self.officer2_data = ['uid2', 'Monaco', 'P', 'Anthony', '1964', '12', '4', 'black / african american', 'female']
        self.officer3_data = ['uid3', 'Maier', '', 'Joel', '', '', '', '', '']
        self.officer4_data = ['uid4', 'Poindexter', 'A', 'Sylvia', '1973', '', '', '', 'male']
