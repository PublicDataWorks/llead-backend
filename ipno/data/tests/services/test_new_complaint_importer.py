...
class NewComplaintImporterTestCase(TestCase):
    ...
    def test_process_successfully(self):
        ...
        self.new_complaint_importer.old_column_mappings = {
        ...
        self.new_complaint_importer.process_wrgl_data = Mock(
        ...
        self.new_complaint_importer.retrieve_wrgl_data.assert_called_with(
            "complaint_repo"
        )
