...
class AgencyImporter(BaseImporter):
    ...
    def __init__(self):
        ...
        self.agency_mappings = {
            agency.slug: agency for agency in Department.objects.only('id', 'slug', 'location', 'location_map_url')
        }
    ...
    def handle_record_data(self, row):
        ...
        if should_update_location:
            try:
                ...
                upload_location = f'{MAP_IMAGES_SUB_DIR}/{current_time}-{agency_slug}.png'
