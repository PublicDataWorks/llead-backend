...
class AppConfigTestCase(TestCase):
    ...
    def test_delete_app_config_cache_when_AppValueConfig_is_saved(self, mock_delete_cache):
    ...
    @patch('app_config.signals.delete_cache')
    def test_delete_app_config_cache_when_AppTextContent_is_saved(self, mock_delete_cache):
    ...
    @patch('app_config.signals.delete_cache')
    def test_delete_front_page_card_cache_when_FrontPageCard_is_saved(self, mock_delete_cache):
    ...
    @patch('app_config.signals.delete_cache')
    def test_delete_front_page_card_cache_when_FrontPageOrder_is_saved(self, mock_delete_cache):
