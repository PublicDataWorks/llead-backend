...
class Complaint(TimeStampsModel):
    ...
    occur_year = models.IntegerField(null=True)
    occur_month = models.IntegerField(null=True)
    occur_day = models.IntegerField(null=True)
    occur_time = models.CharField(max_length=255, null=True, blank=True)
    receive_year = models.IntegerField(null=True)
    receive_month = models.IntegerField(null=True)
    receive_day = models.IntegerField(null=True)
    suspension_start_year = models.IntegerField(null=True)
    suspension_start_month = models.IntegerField(null=True)
    suspension_start_day = models.IntegerField(null=True)
    suspension_end_year = models.IntegerField(null=True)
    suspension_end_month = models.IntegerField(null=True)
    suspension_end_day = models.IntegerField(null=True)
