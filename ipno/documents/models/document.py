...
class Document(TimeStampsModel):
    ...
    pdf_db_id = models.CharField(max_length=255, null=True, blank=True)
    pdf_db_content_hash = models.CharField(max_length=255, null=True, blank=True)
    txt_db_path = models.CharField(max_length=255, null=True, blank=True)
    ...
    dt_source = models.CharField(max_length=255, null=True, blank=True)
    ...
    hrg_text = models.TextField(null=True, blank=True)
